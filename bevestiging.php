...
<section class="bg-white py-8 antialiased  md:py-16">
    <div class="mx-auto max-w-2xl px-4 2xl:px-0">
        <h2 class="text-xl font-semibold text-gray-900  sm:text-2xl mb-2">bedankt voor het inplannen van een afspraak.</h2>
...
<!--                <dd class="font-medium text-gray-900  sm:text-end">--><?php //= $conformation[0]['knipBeurt'] ?><!--</dd>-->
        ...
        <div class="flex items-center space-x-4">
            <a href="#" class="bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 focus:outline-none ">Ga terug naar de hoofdpagina</a>
        </div>
    </div>
</section>
</body>
