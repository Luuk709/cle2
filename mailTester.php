...
$to = "jelle.wijma@gmail.com";
$subject = "test mail";
$type = "test";
$info = new stdClass();
$info->message = "<!DOCTYPE html>
...
//        .content { padding: 20px; max-width: 600px; margin: auto; background: white; }
//        .footer { text-align: center; padding: 10px; background: #343a40; color: white; font-size: 12px; }
//        .button { display: inline-block; margin: 20px 0; padding: 10px 20px; background: #007BFF; color: white; text-decoration: none; border-radius: 5px; }
//    </style>
//</head>
//<body>
//    <div class='header'>
...
//    <div class='content'>
//        <h2>Hello, [Name]</h2>
//        <p>Welcome to our latest update! Here's what's new this month:</p>
//        <ul>
//            <li>Feature A</li>
//            <li>Feature B</li>
//            <li>Feature C</li>
...
//</div>
//    <div class='footer'>
//        <p>&copy; 2025 Our Company | Unsubscribe</p>
//    </div>
//</body>
//</html>
//
